...
enum CountryCallingCode: int
{
    ...
    public function getCountriesAlpha2(): array
    {
        return match($this) {
            ...
            self::Australia                                                                      => [CountryAlpha2::Australia],
            ...
            self::Finland                                                                        => [CountryAlpha2::Finland],
            ...
            self::French_Departments_and_Territories_in_the_Indian_Ocean                         => [CountryAlpha2::French_Southern_Territories],
            ...
            self::Guadeloupe_French_Department_of                                                => [CountryAlpha2::Guadeloupe],
            ...
            self::Morocco_Kingdom_of                                                             => [CountryAlpha2::Morocco],
            ...
            self::New_Zealand                                                                    => [CountryAlpha2::New_Zealand],
            ...
            self::Norway                                                                         => [CountryAlpha2::Norway],
            ...
            self::United_Kingdom_of_Great_Britain_and_Northern_Ireland                           => [CountryAlpha2::United_Kingdom],
