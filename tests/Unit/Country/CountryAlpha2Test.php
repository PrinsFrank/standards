...
class CountryAlpha2Test extends TestCase
{
    ...
    {
        static::assertSame('424.242,4242', CountryAlpha2::Netherlands->formatNumber(424242.4242));
        static::assertSame('4,24,242.4242', CountryAlpha2::Nepal->formatNumber(424242.4242));
    }
